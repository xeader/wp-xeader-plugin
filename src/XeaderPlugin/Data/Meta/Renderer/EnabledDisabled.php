...
class XeaderPlugin_Data_Meta_Renderer_EnabledDisabled extends XeaderPlugin_Data_Meta_Renderer_Text {

	public function render( $display_value, $meta ) {

		$display_value = (bool) $display_value ? __( 'Enabled' ) : __( 'Disabled' );
